...
Automatically parses and analyzes resume content

Scores candidates based on skills, experience, and role relevance

Provides a hiring suitability evaluation (e.g., suitable / partially suitable / not suitable)
...
Practical chatbot design for real-world use cases
...
The chatbot extracts relevant information such as skills, experience, and education.

The extracted data is evaluated against predefined criteria or a target job profile.
...
Results may be inaccurate or biased depending on input quality and scoring logic.
...
Developed by Ekin as a self-improvement and AI experimentation project.
